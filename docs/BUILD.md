...
3. Set your signing team on both **WeekPactMac** and **WeekPactFilter**. Build and run **WeekPactMac** in Xcode. If signing fails, the bundle IDs and App Group in `project.yml` may need to match your team.
